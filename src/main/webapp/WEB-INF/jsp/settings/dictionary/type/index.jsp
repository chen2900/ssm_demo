	...
	<script>
		jQuery(function ($) {
			...
			$("#delBtn2").click(function () {
				...
				if(!confirm("是否确定同时删除类型对应的字典值？")) return;
...
<body>
	...
	<div class="btn-toolbar" role="toolbar" style="background-color: #F7F7F7; height: 50px; position: relative;left: 30px;">
		<div class="btn-group" style="position: relative; top: 18%;">
		  <button type="button" class="btn btn-primary" onclick="window.location.href='/settings/dictionary/type/save.html'"><span class="glyphicon glyphicon-plus"></span> 新增</button>
