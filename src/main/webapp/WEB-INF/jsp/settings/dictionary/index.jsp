...
<head>
	...
	function changePWD() {
		if($("#confirmPwd").val()!=$("#newPwd").val()){
			...
			window.location.href="../../user/changePwd.do?oldPwd="+$("#oldPwd").val()+"&newPwd="+$("#newPwd").val()
		}
	}
</script>
	...
	<div class="modal fade" id="exitModal" role="dialog">
		<div class="modal-dialog" role="document" style="width: 30%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
					<button type="button" class="btn btn-primary" data-dismiss="modal" onclick="window.location.href='../../user/login.html';">确定</button>
				</div>
			</div>
		</div>
	</div>
